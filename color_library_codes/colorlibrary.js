 ...
 */
function HighlighterSet (CategoryName, highlightersJSON, isSetMinimized) {
  ...
  this.toJSON = function () {
    ...
    const json = {};
    json[SET_NAME_KEY] = this.CategoryName;
